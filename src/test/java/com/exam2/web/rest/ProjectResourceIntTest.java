...
import com.exam2.domain.Project;
import com.exam2.repository.ProjectRepository;
...
public class ProjectResourceIntTest {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getNumStudent()).isEqualTo(DEFAULT_NUM_STUDENT);
        assertThat(testProject.getSchedule()).isEqualTo(DEFAULT_SCHEDULE);
    ...
    @Test
    @Transactional
    public void checkNumStudentIsRequired() throws Exception {
        int databaseSizeBeforeTest = projectRepository.findAll().size();
        // set the field null
        project.setNumStudent(null);
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getNumStudent()).isEqualTo(UPDATED_NUM_STUDENT);
        assertThat(testProject.getSchedule()).isEqualTo(UPDATED_SCHEDULE);
